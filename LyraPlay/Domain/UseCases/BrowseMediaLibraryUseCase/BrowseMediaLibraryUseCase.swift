...
public protocol BrowseMediaLibraryUseCaseOutput {
    ...
    func listFiles() async -> Result<[MediaLibraryItem], BrowseMediaLibraryUseCaseError>

    func getFileInfo(fileId: UUID) async -> Result<MediaLibraryItem, BrowseMediaLibraryUseCaseError>
